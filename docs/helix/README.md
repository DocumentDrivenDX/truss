...
| --- | --- | --- |
| 00 Discover | Drafts | [Product vision](00-discover/product-vision.md), [competitive analysis](00-discover/competitive-analysis.md), [discovery input](00-discover/vision-input.md), [naming research](00-discover/naming-research.md) |
| 01 Frame | Next action | [Concerns](01-frame/concerns.md); PRD not started |
| 02 Design | Not started | ADR-001 (TypeScript first, portable core, Rust triggers) pending |
| 03 Test | Not started | — |
